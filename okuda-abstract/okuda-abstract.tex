...
$L^2(G/H)$の既約分解に現れる表現を\Cref{thm:plancherel}を用いて分析するためには$G/H$のランクを知る必要があり，$Y(\real X) $の有界性と$G/H$の判定には$Y(\real X) $の有界性を判定しようとする\Cref{prob:1121}にはこのような表現論的背景もある．
