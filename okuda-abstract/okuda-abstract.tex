...
\begin{yosou-a}(by T.~Kobayashi)\label{yosou:1121}
  ...
  $Y(\real X)$は$ \ha\cap \pe$で有界である$ \iff   [X_1, X_2]\neq 0 $であるか$X_1 = 0$である．
