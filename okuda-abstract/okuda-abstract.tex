...
\Cref{prob:1121}の背景を説明するために\cite{ber88}の内容のごく一部を述べる．\footnote{もう少し自然な言い回しを考えます．2022/01/11}\bluetext{$G$を実簡約Lie群，$H$を$G$の閉部分群とする．$r\colon G/H\to \real_{\geq 0} $がradial functionであるとは，$r$が次を満たすことである．
