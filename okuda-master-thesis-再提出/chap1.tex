...
\begin{skpfwn}{\Cref{cor:prob-eg}}% \bluetext{make it precise}
  ...
  \Cref{lem:1101}より$X$を任意の$k\in K$で$\Ad(k)\ha = \ha $なる$k$に対し$\Ad(k) X$に取り替えて$Y(\real X) $の有界性を議論して一般性を失わないから，$k\in \SO(1,l)\cap\SO(n) $を適当に取ることにより$X =
  \begin{pmatrix}
  ...
  \begin{align*}
    ...
    \begin{array}{cccc|cc}
      ...
      &&&&e\\ \hline
      0&0&0&0&\mbox{\smash{\Huge $I_{l+1}$}}\\
      0&0&0&0&
    \end{array}
               \right)
  \end{align*}
