...
\begin{rem}\label{rem:loc-isom}
  ...
  \begin{lem}\label{lem:loc-isom}
    ...
    このとき任意の$X\in \pe_1$に対し，$Y_1(\real X) $が有界であることと，$Y_2(\real \phi(X)) $が有界であることは同値である．
  \end{lem}
  \begin{npfwn}[\Cref{lem:loc-isom}]
    ...
    $\phi|_{\pe_1} \colon \pe_1\to \pe_2$が内積を保つことと$\phi(\ha_1) = \ha_2 $より，$\phi(Y_1(X))\in \ha_2\cap \pe_2 $，$\phi(Z_1(X))\in \per{\ha_2}\cap \pe_2 $であり，したがって\Cref{thm:kob89-lem6.1}より$Y_2(X) = \phi(Y_1(X)) $，$Z_2(X) = \phi(Z_1(X)) $である．ただし$Y_i$，$Z_i$，$i=1,2$は微分同相写像
    \begin{align*}
    ...
    $\phi|_{\pe_1} \colon \pe_1\to \pe_2$は内積を保つ写像であったから，$X\in \pe$に対して$Y_1(\real X) $が有界であることと，$Y_2(\real \phi(X)) $が有界であることは同値である．
  \end{npfwn}
\end{rem}
