...
ここでRiemann対称空間$G/K\simeq \pe$はcocompactなHadamard多様体である．

次の定理より，$G/K$に対して\Cref{thm:visibility-and-rank}の (ii) は$G$の実階数が1以下であることと同値である．
\begin{thm}(\cite[]{helgason01})
