...
\begin{pfwn}{\Cref{prop:yosou-eg}}
  ...
  ここで\Cref{lem:riem-metric-su11}より$r = \tanh t$，$h = \tanh s$であり\Cref{eq:1018-main} は$\cos\theta \tanh 2t = \tanh 2s $と書き直せる．したがって$X_{\theta}$に対して$Y(\real X) $が有界$\iff \abs{\cos\theta}\neq 1 \iff  X\nin \ha  $である．
