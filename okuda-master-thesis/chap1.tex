...
\begin{npfwn}[\Cref{lem:0117-decomp}]
  ...
  $[X_c, X_s] = 0 $より$\exp(X)\cdot o_K = \exp(X_c)\exp(X_s)\cdot o_K $であり，$\ze(\ge')\cap \ge_s' = \emptyset $より\bluetext{$\exp(X_c)\exp(X_s)\cdot o_K = \exp(X_c')\exp(X_s')\cdot o_K $ならば$X_c = X_c' $，$X_s = X_s'$である．fix this}
