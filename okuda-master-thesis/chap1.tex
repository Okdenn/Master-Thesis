...
\begin{lem}\label{lem:0117-decomp}
  $X = X_c + X_s \in \ge' $と任意の$t\in \real$に対し$Y(tX) = tX_c + Y(tX_s) $である．
\end{lem}
...
\begin{npfwn}[\Cref{lem:basic-prob}]
  ...
  \item $X\in \pe$が\Cref{cond:0117}を満たさないとき，$X\in \pe\setminus\pe_{H,\bdd} $であることを示せば良い．
    ...
    $X\in \pe$が\cnum{1}を満たさないことから$X\in\pe\setminus\per{\ha} $である．
    ...
    このとき\cnum{2}，\cnum{3}が成り立たないことから$X\nin \ge_{s}' $ならば$X = X_c + X_s $に対し$X_c\neq 0$であるから\Cref{lem:0117-decomp}より
