...
\begin{pfwn}{\Cref{prop:yosou-eg}}
  ...
  \begin{pmatrix}
    \cosh t & \sinh t \\ \sinh t & \cosh t
  \end{pmatrix}
  k_{-\theta/2}$とし，この$X$と$t\in \real$に対して$Y(tX)$を求める．
  ...
  右の円の Euclid 距離での半径を$R$とし，$e^{X}\cdot o_K $から$H\cdot o_K$への垂線の足の$o_K$からの Euclid 距離を$h$とするとき，青色の直角三角形に対して三平方の定理を用いて$(h+R)^2 = R^2 +  1 $より$R = \frac{1-h^2}{2h} , R+h = \frac{1+h^2}{2h}  $を得る．
  ...
  ここで，任意の$0\leq r, h < 1$に対し，ある$t,s\in \real_{\geq 0} $が存在して，$r = \tanh t$，$h = \tanh s$と書け，このとき \Cref{eq:1018-main} は$\cos\theta \tanh 2t = \tanh 2s $と書き直せる．


\end{pfwn}

\begin{cor}
  $G = \SO(1,n) $，$H = \SO(1,k) $に対して\Cref{yosou:1121}は正しい．
\end{cor}
