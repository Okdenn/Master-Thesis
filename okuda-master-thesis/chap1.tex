...
\begin{lem}\label{lem:0117-decomp}
  \Cref{lem:0117-perp}の仮定のもとで $X = X_c + X_s \in \ge' $と任意の$t\in \real$に対し$Y(tX) = tX_c + Y(tX_s) $である．
\end{lem}
