...
\begin{thm}\label{thm:1216-main}
  $G$を実階数1の実半単純Lie群，$H$を$G$の非コンパクトな閉部分Lie群で，$G$のCartan対合$\Theta$に対して$\Theta H = H$かつ$\dim \ha = 1$とするとき，\Cref{prob:1121}が成り立つ．
\end{thm}
