...
\begin{thm}\label{thm:1216-main}
  $G$を実階数1の実半単純Lie群，$H$を$G$の非コンパクトな閉部分Lie群で，$G$のCartan対合$\Theta$に対して$\Theta H = H$かつ$\dim \ha = 1$とするとき，\Cref{yosou:1121}が成り立つ．
\end{thm}
...
\begin{npfwn}[\Cref{thm:1216-main}]\bluetext{おそらく$\dim H = 1$出ない場合も背理法で示せる気がする．}
