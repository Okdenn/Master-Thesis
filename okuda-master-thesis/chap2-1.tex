...
上の補題より，$G$が実階数1ならば，$\Sigma(\ge,\ah) = \{\pm\alpha\} $あるいは$\Sigma(\ge,\ah)  = \{\pm\alpha, 2\pm\alpha \} $であるから，任意の$Y\in \ha\setminus\{0\} $と任意の$X\in \pe\setminus \ha$を固定したとき，$X,Y$を含む部分Lie環$\ge'\subset \ge$で，$\ge'\simeq \sulie(1,2) $か$\ge'\simeq \sulie(1,1)$なるものが存在する．
