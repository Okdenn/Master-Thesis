...
\begin{pfwn}{\Cref{thm:1216-main}}
  ...
  \begin{case}
    ...
    \Cref{cor:sub-lie-alg}により$X$と$\ha $を含む部分Lie環$\ge' \subset \ge $で$\sulie(1,1) $に同型なものが存在する．$\ge' $に対応する$G$の解析的部分群を$G'$とし，その岩澤分解を$G' = K'A'N' $とする．このとき$G'/K = G'/K'$は$G/K$内の$Z(tX)\in \ge'\cap \per{\ha}\cap \pe $であり，
