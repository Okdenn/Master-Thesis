...
\begin{nttdef}
  ...
  \item $\Sigma(\ge,\ah) $を$\ah$に関する制限ルート系とする．$\ge_{\lambda} $を，$\lambda\in \ah^{*}$のルート空間とし，$Y_{\alpha}\defeq [\theta X_{\alpha}, X_{2\alpha}] $とする．
...
\begin{pfwn}{\Cref{thm:0810}}
  ...
  $[X_{\alpha}^{*}, Y_{\alpha}^{*}] = -4X_{2\alpha}^{*} $ (\Cref{lem:3.2}による)，$[X_{\alpha}^{*},[X_{\alpha}^{*}, \theta Y_{\alpha}^{*}]]  = -6Y_{\alpha}^{*}$ (\Cref{lem:3.3}による)，$[X_{\alpha}^{*}, \theta X_{\alpha}^{*}] = -24A_{\alpha}^{*} $ (定義による)，$[X_{\alpha}^{*},X_{2\alpha}^{*}] = 0$ ($\ge_{3\alpha} = 0$による)，$[X_{\alpha}^{*}, \theta X_{2\alpha}^{*}] = \theta Y_{\alpha}^{*} $，\\
  $[Y_{\alpha}^{*},X_{2\alpha}^{*}] = 0$ (\Cref{lem:3.5}による)，$[Y_{\alpha}^{*},\theta X_{2\alpha}^{*}] = -4\theta X_{\alpha}^{*} $ (\Cref{lem:3.6}による)，$[Y_{\alpha}^{*}, \theta Y_{\alpha}^{*}] = -96A_{\alpha}^{*} $ (\Cref{lem:3.4}による)，$[Y_{\alpha}^{*}, [X_{\alpha}^{*}, \theta Y_{\alpha}^{*}]] = 24X_{\alpha}^{*} $ (\Cref{lem:3.4}による) \\
  $[[X_{\alpha}^{*}, \theta Y_{\alpha}], X_{2\alpha}^{*}] = [[X_{\alpha}^{*}, \theta Y_{\alpha}], \theta X_{2\alpha}^{*}] = 0$ ($\bcs$\Cref{lem:3.6})，$[X_{2\alpha}^{*} ,\theta X_{2\alpha}^{*} ] = -48A_{\alpha}^{*} $
...
\begin{lem}
  \Cref{cor:sub-lie-alg}の$\ge_0$の$G$における解析的部分群を$G_0$とする．
\end{lem}
...
\begin{pfwn}{\Cref{thm:1216-main}}
  ...
  % $X\nin \ha$に対して$Y(\real X)$が有界であることを背理法により示す．
