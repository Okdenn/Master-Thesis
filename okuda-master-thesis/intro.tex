...
本論文では小林俊行氏による次の問題 (後述\Cref{prob:1121}) について考察し，$G$が実階数1の実半単純Lie群の場合に肯定的な結果を得た．
\begin{prob*}
...
ここで$G$が実階数1のとき，「$X\in \per{\ha}\cap\pe $もしくは『$ [X_1, X_2]\neq 0 $かつ$\ze_{\ze(\ha)}(X) = 0$であること』」と$X\in \{0\}\cup\pe\setminus\ha $は同値である (後述\Cref{lem:basic-prob}の3)．
