...
\Cref{prob:1121}の表現論的背景を説明するために\cite{ber88}の内容についてふれる．
...
以上のように$G/H$のランクを求めることと$Y(\real X) $の有界性の判定には関係がある．$Y(\real X) $の有界性を判定しようとする\Cref{prob:1121}にはこのような表現論的背景もある．
